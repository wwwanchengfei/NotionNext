...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '生活过得好一点，比大多数宏伟更宏伟。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wanchengfei.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Next, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'wwwanchengfei@gmail.com', // 邮箱地址 例如mail@tangly1024.com
